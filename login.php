...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (count($errors) > 0) {
        ...
        $sql = "select * from users where email = '$email' and password = '$password' and role_id = 3";
...
<!--                                <div class="small"><a href="./Admin/patients/create.php">Need an account? Sign up!</a></div>-->
